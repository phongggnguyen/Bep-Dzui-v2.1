        ...
        <nav className="fixed bottom-4 left-4 right-4 bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 flex justify-around p-4 sm:hidden z-50">
          ...
          <div className="-mt-8">
            <NavLink
              to="/recipe"
              className={({ isActive }) =>
                `flex items-center justify-center w-14 h-14 rounded-full shadow-lg shadow-orange-200 transition-transform active:scale-95 ${
                  isActive ? 'bg-gray-800 text-white' : 'bg-orange-500 text-white'
                }`
              }
            >
              <ChefHat size={28} />
