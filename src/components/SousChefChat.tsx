...
export default function SousChefChat() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      <div
        className={`fixed z-50 bottom-20 sm:bottom-8 right-4 sm:right-8 w-[90vw] sm:w-96 bg-white rounded-3xl shadow-2xl border border-orange-100 flex flex-col transition-all duration-300 origin-bottom-right ${isOpen
