...
export default function SousChefChat() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      <div
        className={`fixed z-50 bottom-20 sm:bottom-8 right-4 sm:right-8 w-[90vw] sm:w-96 bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-orange-100 dark:border-gray-800 flex flex-col transition-all duration-300 origin-bottom-right ${isOpen
      ...
      >
        ...
        {/* Messages Area */}
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#FFF7ED] dark:bg-gray-950 scrollbar-hide">
          {messages.map((msg, idx) => (
            <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
              <div
                className={`max-w-[88%] p-3.5 rounded-2xl text-sm shadow-sm ${msg.role === 'user'
        ...
        {/* Input Area */}
        <div className="p-3 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 rounded-b-3xl">
          <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-800 p-1.5 rounded-full border border-gray-200 dark:border-gray-700 focus-within:border-orange-300 dark:focus-within:border-orange-600 focus-within:bg-white dark:focus-within:bg-gray-700 focus-within:shadow-inner transition-all duration-300">
            <input
              type="text"
              value={input}
